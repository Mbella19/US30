"""
Verify that raw market data has proper time continuity (weekend gaps removed).

Checks: Time gaps between bars (should only be weekends, not flat prices)
Related: check_flat_data.py (checks for stale/identical price sequences)

Usage:
    python scripts/analysis/verify_gap_removal.py
"""
